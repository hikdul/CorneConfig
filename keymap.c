...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
    CTL_T(KC_DEL), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, CTL_T(KC_DEL),
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                     KC_LEFT_ALT,LT(1,KC_ENT),KC_TAB,  KC_SPC ,LT(2,KC_ENT),KC_LGUI
                                      //`--------------------------'  `--------------------------'
...
// Sonido - navegacion
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LEFT_ALT, MO(3),KC_TAB,   KC_ENT, MO(3), KC_LGUI
                                      //`--------------------------'  `--------------------------'
  ),
// npi ya venia asi
